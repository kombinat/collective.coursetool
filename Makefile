...
PROJECT_NAME=collective.coursetool
...
# version ok?
PYTHON_VERSION_MIN=3
PYTHON_VERSION_OK=$(shell $(PYTHON) -c 'import sys; print(int(float("%d"% sys.version_info[0]) >= float($(PYTHON_VERSION_MIN))))' )
